theme_twitter <- function(){
  ggplot2::theme(
    title = ggplot2::element_text(family = "Chirp"),
    text = ggplot2::element_text(family = "Chirp", size = 12),
    ...
    strip.background = ggplot2::element_rect(fill = twColor("darkblue"), colour = NA),
